...
<body>
    ...
    <!-- Gmaps -->
    <script src="{{ asset('style/https://maps.googleapis.com/maps/api/js?v=3&sensor=false') }}"></script>
    <script src="{{ asset('style/https://maps.googleapis.com/maps/api/js?key=AIzaSyD2jlT6C_to6X1mMvR9yRWeRvpIgTXgddM') }}"></script>
