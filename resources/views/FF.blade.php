    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb" style="height:30px;">
          ...
          <a href="{{url('settingproduct3')}}" type="button" class="btn btn-sm btn-default"><i class="fa fa-cog"></i> Setting</button></a>
                                      <a href="{{url('resetindex3')}}"><button class="btn btn-sm btn-default"><i class="fa fa-exclamation-triangle"></i> Reset Index</button></a>
                        </div>
        </ol>
                              </div>
    </div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <td>1</td>
                ...
                <td>2021-09-11 18:11:18</td>
                <td>
                  <a href="{{url('namamerchant3')}}">Machili</a>
                </td>
                <td>ayez</td>
                <td>rp.200.000</td>
